...
public class GuiLegacyFlag extends ScreenContainerAbstract
    ...
    public void init() {
        ...
        for (int i = 0; i < 6; ++i) {
            this.toolBtns[i] = new TexturedButtonElement(i, useless.legacyui.settings.LegacySettings.guiTexture("legacyflag"), this.GUIx + 12 + 23 * i, this.GUIy + 12, 20 * i, 196, 20, 20);
        ...
        this.eraseButton = new TexturedButtonElement(6, useless.legacyui.settings.LegacySettings.guiTexture("legacyflag"), this.GUIx + 128, this.GUIy + 118, 120, 196, 18, 18);
    ...
    public void handleInputs(){
        ...
        if (repeatInput(GameSettings.KEY_RIGHT.getKeyCode(), UtilGui.tabScrollRepeatDelay, UtilGui.tabScrollInitialDelay) || repeatInput(GameSettings.KEY_LOOK_RIGHT.getKeyCode(), UtilGui.tabScrollRepeatDelay, UtilGui.tabScrollInitialDelay)){
            if (shifted){
        ...
        if (repeatInput(GameSettings.KEY_LEFT.getKeyCode(), UtilGui.tabScrollRepeatDelay, UtilGui.tabScrollInitialDelay) || repeatInput(GameSettings.KEY_LOOK_LEFT.getKeyCode(), UtilGui.tabScrollRepeatDelay, UtilGui.tabScrollInitialDelay)){
            if (shifted){
                setActiveTool(this.activeTool - 1);
            } else {
                setCursorX(cursorX - 1);
        ...
        if (repeatInput(GameSettings.KEY_FORWARD.getKeyCode(), UtilGui.verticalScrollRepeatDelay, UtilGui.verticalScrollInitialDelay) || repeatInput(GameSettings.KEY_LOOK_UP.getKeyCode(), UtilGui.verticalScrollRepeatDelay, UtilGui.verticalScrollInitialDelay)){
            selectColor(selectedColor - 1);
        }
        if (repeatInput(GameSettings.KEY_BACK.getKeyCode(), UtilGui.verticalScrollRepeatDelay, UtilGui.verticalScrollInitialDelay) || repeatInput(GameSettings.KEY_LOOK_DOWN.getKeyCode(), UtilGui.verticalScrollRepeatDelay, UtilGui.verticalScrollInitialDelay)){
            selectColor(selectedColor + 1);
        }
        if (KeyboardHelper.isKeyPressedThisFrame(GameSettings.KEY_JUMP.getKeyCode())){
            selectDye(cursorX);
        }
    }
    ...
    protected void drawGuiContainerForegroundLayer(){
        mc.textureManager.loadTexture(useless.legacyui.settings.LegacySettings.guiTexture("legacyflag")).bind();
        net.minecraft.client.render.renderer.GLRenderer.setColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        drawTexturedModalRect(11 + 18 * cursorX, 34, 138, 232, 24,24);
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(final float f) {
        this.mc.textureManager.loadTexture(useless.legacyui.settings.LegacySettings.guiTexture("legacyflag")).bind();
        net.minecraft.client.render.renderer.GLRenderer.setColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        final int textX = 148;
        if (selectedColor == 0) {
            this.drawStringShadow(this.fontRenderer, "1", this.GUIx + textX, this.GUIy + 66, -1);
        } else {
            this.drawStringNoShadow(this.fontRenderer, "1", this.GUIx + textX, this.GUIy + 66, -8421505);
        }
        if (selectedColor == 1) {
            this.drawStringShadow(this.fontRenderer, "2", this.GUIx + textX, this.GUIy + 85, -1);
        } else {
            this.drawStringNoShadow(this.fontRenderer, "2", this.GUIx + textX, this.GUIy + 85, -8421505);
        }
        if (selectedColor == 2) {
            this.drawStringShadow(this.fontRenderer, "3", this.GUIx + textX, this.GUIy + 104, -1);
        } else {
            this.drawStringNoShadow(this.fontRenderer, "3", this.GUIx + textX, this.GUIy + 104, -8421505);
        }
        if (selectedColor == 3) {
            this.drawStringShadow(this.fontRenderer, "4", this.GUIx + textX, this.GUIy + 123, -1);
        } else {
            this.drawStringNoShadow(this.fontRenderer, "4", this.GUIx + textX, this.GUIy + 123, -8421505);
        }
    }
    ...
    public void keyPressed(final char eventCharacter, final int eventKey, final int mx, final int my) {
        ...
        if (eventKey == Keyboard.KEY_ESCAPE || GameSettings.KEY_INVENTORY.isKeyboardKey(eventKey) || eventKey == Keyboard.KEY_BACK) {
