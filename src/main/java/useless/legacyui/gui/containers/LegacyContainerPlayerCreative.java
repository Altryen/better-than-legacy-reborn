...
public class LegacyContainerPlayerCreative extends MenuInventoryCreative {
    ...
    public LegacyContainerPlayerCreative(final ContainerInventory inventory) {
        super(inventory);
    ...
    public void createSlots() {
        ...
        for (int index = 0; index < 4; ++index) { // Create Armor Slots
            this.addSlot(new SlotArmor(this, inventory, inventory.getContainerSize() - 1 - index, -5000, -5000, HumanArmorShape.values()[3 - index]));
        }
